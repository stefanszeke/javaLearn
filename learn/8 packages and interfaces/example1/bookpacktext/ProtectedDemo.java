...
public class ProtectedDemo {
    public static void main(String[] args) {
        ...
        // books[0].title = "test title"; // Error -- not accessible, because title is protected
        books[0].setTitle("Java: A Beginner's Guide 9th Edition"); // OK, because setTitle() is public
    }
}
